...
func (a *APIResponse) Decode(responseBody io.Reader) error {
	return json.NewDecoder(responseBody).Decode(a)
}

func (a *APIResponse) DebugString() string {
	b, _ := json.Marshal(a)
	return string(b)
}
...
// buttons GetWithID can be used instead of this object to specify text of the
